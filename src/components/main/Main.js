    ...
    <div className={s.container}>
      <div className={s.mainItem1}>
        <div>
          ...
          <div className={s.PO}>
            Включено ПО в реестр: <span className={s.colorNum}>13 438</span>
            <br />
            Правообладателей: <span className={s.colorNum}>4 272</span>
          </div>
      ...
      <div className={s.mainItem3}>
        ...
        <div className={s.btn}>
          {!edit ? (
            <button className={s.butNews} onClick={newsEdit}>
              Показать все
            </button>
          ) : (
            <button className={s.butNews} onClick={newsEdit}>
