...
const Table1 = (props) => {
  ...
  const data = [
    ...
    },
    {
      ...
      kod: '04.03',
      class:
        'Системы сбора, хранения, обработки, анализа, моделирования и визуализации массивов данных (Команда)',
      date: '20.03.2016',
      adress: 'Ссылка',
      key: '10',
    },
    {
      num: '#11',
      name: 'Система управления базами данных «Ред База Данных (Команда)»',
      kod: '02.09',
      class: 'Системы управления базами данных (Команда)',
      date: '26.01.2016',
      adress: 'Ссылка',
      key: '11',
    },
