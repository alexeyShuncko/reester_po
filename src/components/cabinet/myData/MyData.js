  ...
  return (
    <div className={s.containerCabinet}>
      ...
      <Form
        ...
        <div style={{ display: 'flex' }}>
          <Form.Item name="name" style={{ marginBottom: 20 }}>
            <div>
              ...
              <input
                className={s.inpMy}
                defaultValue={props.users.name}></input>
            </div>
          </Form.Item>
          <Form.Item name="famili" style={{ marginBottom: 20 }}>
            <div>
              <div className={s.labelInput}>Фамилия</div>
              <input
                className={s.inpMy}
                defaultValue={props.users.famili}></input>
            </div>
          </Form.Item>
        </div>
        <div style={{ display: 'flex' }}>
          <Form.Item name="faser" style={{ marginBottom: 20 }}>
            <div>
              <div className={s.labelInput}>Отчество</div>
              <input
                className={s.inpMy}
                defaultValue={props.users.faser}></input>
            </div>
          </Form.Item>
          <Form.Item name="country" style={{ marginBottom: 20 }}>
            <div>
              <div className={s.labelInput}>Страна</div>
              <div style={{ position: 'absolute' }} onClick={rotaitArr}>
                <select
                  className={s.selectMy}
                  defaultValue={props.users.country}>
        ...
        <div style={{ display: 'flex' }}>
          <Form.Item name="sity" style={{ marginBottom: 20 }}>
            <div>
          ...
          <Form.Item name="tel" style={{ marginBottom: 20 }}>
            <div>
              <div className={s.labelInput}>Мобильный телефон</div>
              <input
                type={'tel'}
                className={s.inpMy}
                defaultValue={props.users.tel}></input>
            </div>
          </Form.Item>
        </div>
        <div className={s.lineMy}></div>
        ...
        <div style={{ display: 'flex' }}>
          <Form.Item name="pass" style={{ marginBottom: 20 }}>
            <div>
              ...
              <div className={s.block}>
                <input
                  ...
                  id="passNew"
                  className={s.inpMy}
                  defaultValue={props.users.pass}></input>
                <img alt="Глаз" src={eye} className={s.eye} onClick={pass} />
              </div>
            </div>
          </Form.Item>
          <Form.Item name="passTu" style={{ marginBottom: 20 }}>
            <div>
